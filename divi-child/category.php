...
<div id="main-content">
	<div class="container">
		<div id="content-area" class="clearfix">
			<div id="left-area">
<!-- Style Page Title-->	
<h1 class="entry-title" style="padding-bottom: 25px;"><!--Title Prefix--><?php single_cat_title(); ?><!--Title Suffix--></h1>
		<?php
			if ( have_posts() ) :
...
<!--Edit inline style in a tag below to adjust thumbnails size and float -->
						<a class="entry-featured-image-url" href="<?php the_permalink(); ?>" style="max-width: 25%; float:left;">
